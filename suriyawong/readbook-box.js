(() => {
  ...
  const EXEC_CACHE_KEY = 'LP360:TAMBOL:SURIYAWONG:SITE_FAST:readbook-exec-d26-v1';
  const EXEC_CACHE_AGE = 10 * 60 * 1000;
  const CATALOG_CACHE_KEY = 'LP360:TAMBOL:SURIYAWONG:SITE_FAST:readbook-catalog-v1';
